...
const buildtabel = () => {
  ...
  let singlepgaedata = mylist.map(function (value, index, array) {
    ...
    return(
        ` <tr>
                  ...
                  <td> <img class="imgsize" src="${value.image}"></td>
  ...
  document.getElementById("datatabel").innerHTML = singlepgaedata.join(" ");
